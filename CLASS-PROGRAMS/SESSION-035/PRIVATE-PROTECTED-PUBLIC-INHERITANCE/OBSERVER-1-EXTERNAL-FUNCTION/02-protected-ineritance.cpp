...
void external_function() 
{
    ...
    // objD11.B11_public_num = 100;    //  (public inheritance ok) -> (protected inheritance CTE)
    objD11.D11_public_num = 200; 

    // objD12.B11_public_num = 300;    //  (public inheritance ok)  -> (protected inheritance CTE)
