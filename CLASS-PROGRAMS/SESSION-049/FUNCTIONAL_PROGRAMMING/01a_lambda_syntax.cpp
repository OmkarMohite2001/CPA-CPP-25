...
int main(){
	...
	b = [] (std::string& a, std::string& b) -> bool 
            ...
            }(std::string("Hello,World"), std::string("abc"));
...
bool test(){
    ...
    Internal class corrossponding to lambda. 
    ...
    class C 
    {
        private: 
            int m_loc, m_kb; 
        public: 
            C(int _loc, int _kb) : m_loc(_loc), m_kb(_kb){} 
    ...
    C internalObject(loc, kb); 

    auto b = internalObject(); 
    */
...
class InternalClass 
{
    private: 
        int m_v1; 
    public: 
        InternalClass(int _v1) : m_v1(_v1) // m_v1 == 42 
        {
        }
...
InternalClass InternalObject(v1); 

v1 = 500; 

int val = InternalObject(); 
...
/*
    ...
    class InternalClass 
    {
        private: 
            int& ref; 
        public: 
            InternalClass(int& _v1) : ref(_v1)  // ref refers to 
                                                //  v1 in outer function
            {
            }
    ...
    InternalObject = InternalClass(v1); 
