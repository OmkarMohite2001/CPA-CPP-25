...
int main(void)
{
    ...
    // Expectation : global_num will reflect its changed state 1000
...
//  variable is visible to all functions in the source file wherein they are defined but not in other source files 
